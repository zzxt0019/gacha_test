import {Col, Form, InputNumber, Row, Select, Spin, Tooltip} from "antd";
...
export function WishPage() {
    ...
    return (
        <>
            <Form layout={'inline'} size={'small'} disabled={true}>
                <Form.Item label={'5星角色'}>
                    ...
                    <Row>
                        ...
                        <Col>
                            <Select value={weaponState[0][1]} disabled={loading} bordered={false}
                                ...
                                {[0, 1, 2].map(value => <Select.Option value={value}>定轨{value}</Select.Option>)}
                            </Select>
                        </Col>
                    </Row>
                </Form.Item>
                <Form.Item label={'4星角色'}>
